...
INSERT INTO `log` (`id`, `member_id`, `post_id`) VALUES
(0, 2, 1);
...
(3, 'mem01', '1234', 'mem01@labor.gov.tw'),
(4, 'mem02', '5678', 'mem02@labor.gov.tw');
...
INSERT INTO `post` (`id`, `title`, `text`, `sh`, `good`, `type`) VALUES
...
(1, '問題一：你最常做什麼運動來促進健康體能呢?', 2, 0),
(2, '1.健走或爬樓梯、慢跑等較不受時間、場地限制的運動。', 1, 1),
(3, '2.仰臥起坐、抬腿及伏地挺身、伸展操、瑜珈等室內運動。', 3, 1),
